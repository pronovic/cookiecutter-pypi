...
Go to the PyCharm settings and find the `{{ cookiecutter.project_slug }}` project.  Under **Project
...
create an API token with upload permissions for the {{ cookiecutter.project_slug }}
