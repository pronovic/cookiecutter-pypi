...
To report a security issue, please use the GitHub Security Advisory ["Report a Vulnerability"](https://github.com/{{ cookiecutter.github_owner }}/{{ cookiecutter.github_repo }}/security/advisories/new) tab.
